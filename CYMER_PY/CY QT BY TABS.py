...
#! ________________________ UPDATE FILE SAVE NAME FIRST ____________________
date='test'
start_time=time.time()
yt = pd.read_hdf("../H5/QUOTES.H5",key='CY')
TYPE=pd.read_hdf("../H5/CY_ADJ.H5",key='OLD-NEW TYPES')
...
xt=pd.read_hdf("../H5/CY_ADJ.H5",key='2021 TOTALS')
ttl=pd.read_hdf("../H5/CY_ADJ.H5",key='TOOL_COSTS')
macro_book=xl.Book("../MACRO.XLSM")
book=xl.Book()
...
macro_book.close()
del xl
book.save(f"../../CYMER/CYMER COSTING/UCT Q4 22 Cymer Product Pricing {date}.xlsx")