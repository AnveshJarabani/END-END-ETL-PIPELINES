...
SM=pd.DataFrame()
rt
SM['SM']=np.array(rt.loc[rt['WC'].str.contains(r'BRAKE|LASER|TRT',na=False),"MATERIAL"].unique()).tolist()
...
rt.loc[(rt['OP_QTY'].isnull())&(rt['WC'].str.contains(r'BRAKE|LASER|TRT|SAW')),'BASE_QUANTITY'] = 10
